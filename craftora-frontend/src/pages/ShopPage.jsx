    ...
    <div className="pt-24 pb-16 min-h-screen" style={{ background: 'var(--cream)' }}>
      <div className="section-container">
        ...
        <AnimatePresence>
          {filtersOpen && (
            <motion.div
              className="glass rounded-2xl p-8 mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8"
              initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
              exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }}
            >
              {/* Price range */}
              <div>
                <label className="block text-xs font-semibold mb-3 uppercase tracking-wide" style={{ color: 'var(--terracotta)' }}>Price Range (₹)</label>
              ...
              {/* Min rating */}
              <div>
                <label className="block text-xs font-semibold mb-3 uppercase tracking-wide" style={{ color: 'var(--terracotta)' }}>Min Rating</label>
                  ...
                  <label key={key} className="flex items-center gap-3 cursor-pointer">
                    ...
                    >
                      <div className="w-5 h-5 bg-white rounded-full absolute top-0.5 transition-all shadow"
                        style={{ left: filters[key] ? '20px' : '2px' }} />
                    </div>
                    <span className="flex items-center gap-2 text-sm" style={{ color: 'var(--charcoal)' }}>{icon}{label}</span>
                  </label>
                ))}
              </div>
            </motion.div>
